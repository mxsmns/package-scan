...
Welcome to ``package-scan`` contributor's guide.
...
If you experience bugs or general issues with ``package-scan``, please have a look
...
You can help improve ``package-scan`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``package-scan`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``package-scan``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/package-scan.git
    cd package-scan
...
#. Install |pre-commit|_::
   ...
   ``package-scan`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/package-scan
.. _issue tracker: https://github.com/<USERNAME>/package-scan/issues
.. <-- end -->
